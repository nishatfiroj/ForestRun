...
SOURCES            = main.c myLib.c game.c start.c instructions.c pause.c holder.c lose.c spritesheet.c rupee.c hiss.c foreground.c background.c collisionmap.c bg.c sound.c thud.c
CCPATH             = /usr/bin
